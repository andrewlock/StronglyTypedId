...
namespace StronglyTypedId.Generator
{
    public static class SyntaxTreeGenerator
    {
        ...
        public static SyntaxList<MemberDeclarationSyntax> CreateStronglyTypedIdSyntax(StructDeclarationSyntax original)
        {
                ...
                .WithMembers(
                    List<MemberDeclarationSyntax>(
                        new MemberDeclarationSyntax[] {
                            ...
                            .WithSemicolonToken(
                                Token(SyntaxKind.SemicolonToken))
                        , ClassDeclaration(typeConverterName)
                            .WithBaseList(
                                BaseList(
                                                        ...
                                                        ArgumentList(
                                                            SeparatedList<ArgumentSyntax>(
                                                                new SyntaxNodeOrToken[]{
                                                                    ...
                                                                    Argument(
                                                                        IdentifierName("value"))}))))))})),
                            ClassDeclaration(jsonConverterName)
                            .WithBaseList(
                                BaseList(
                                    SingletonSeparatedList<BaseTypeSyntax>(
                                        SimpleBaseType(
