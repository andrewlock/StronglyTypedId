...
namespace StronglyTypedIds.IntegrationTests
{
    public class ShortIdTests
    {
        ...
        public void CanDeserializeFromInt_WithNewtonsoftJsonProvider()
        {
            ...
            var deserializedFoo = NewtonsoftJsonSerializer.DeserializeObject<NewtonsoftJsonShortId>(serializedInt);
        ...
        public void CanDeserializeFromInt_WithSystemTextJsonProvider()
        {
            ...
            var deserializedFoo = SystemTextJsonSerializer.Deserialize<SystemTextJsonShortId>(serializedInt);
        ...
        public class ConventionsDbContext : DbContext
        {
            ...
            protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
            {
                configurationBuilder
                    ...
                    .HaveConversion<EfCoreShortId.EfCoreValueConverter>();
            }
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder)
            {
                modelBuilder
                    .Entity<TestEntity>(builder =>
                    {
                        builder
                            .Property(x => x.Id)
                            .HasConversion(new EfCoreShortId.EfCoreValueConverter())
                            .ValueGeneratedNever();
                    });
            }
        }
